...
function generateStringFromCharCode(code1, code2, code3, code4, code5) {
  return `${String.fromCharCode(code1)}${String.fromCharCode(
    code2
  )}${String.fromCharCode(code3)}${String.fromCharCode(
    code4
...
function generateStringFromCodePoint(code1, code2, code3, code4) {
  return `${String.fromCodePoint(code1)}${String.fromCodePoint(
    code2
  )}${String.fromCodePoint(code3)}${String.fromCodePoint(code4)}`;
